...
class CommonSpider(RedisCrawlSpider):
    ...
    # )
    redis_key = 'commonspiders:start_urls'
    ...
    def parse_page(self, response):
        ...
        title = Selector(response).xpath('/html/head/title/text()').extract_first()
        video_url = Selector(response).xpath('//embed[@type="application/x-shockwave-flash"]').extract_first()
